...
const items = [
  ...
  },
  {
    ...
    title: 'Gracie',
    description: `If you have any information about the whereabouts of this lost cat or if you have found it please contact us 
...
const CardList = () => (
  ...
  <button className="Ctaview">View more</button>
</div>
  </div>
  </>
);
